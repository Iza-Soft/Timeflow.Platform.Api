...
namespace Timeflow.Platform.Infrastructure.Migrations
{
    ...
    [Migration("20231006103119_AddFKOneCurrencyToOneHourlyRate")]
    partial class AddFKOneCurrencyToOneHourlyRate
    {
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ContractorEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 6, 13, 31, 19, 90, DateTimeKind.Local).AddTicks(3349));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.CurrencyEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 13, 31, 19, 91, DateTimeKind.Local).AddTicks(236));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.CustomerEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 13, 31, 19, 90, DateTimeKind.Local).AddTicks(5513));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.HourlyRateEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 13, 31, 19, 91, DateTimeKind.Local).AddTicks(722));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ProjectEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 13, 31, 19, 90, DateTimeKind.Local).AddTicks(5868));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.TimeSheetEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 13, 31, 19, 90, DateTimeKind.Local).AddTicks(6153));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.HourlyRateEntity", b =>
                {
                    b.HasOne("Timeflow.Platform.Infrastructure.Entities.CurrencyEntity", "Currency")
                        .WithOne()
                        .HasForeignKey("Timeflow.Platform.Infrastructure.Entities.HourlyRateEntity", "CurrencyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
