...
namespace Timeflow.Platform.Infrastructure.Migrations
{
    ...
    [Migration("20231006074621_AddIdInComposePKTableHourlyRate")]
    partial class AddIdInComposePKTableHourlyRate
    {
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ContractorEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 6, 10, 46, 21, 534, DateTimeKind.Local).AddTicks(5958));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.CurrencyEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 10, 46, 21, 534, DateTimeKind.Local).AddTicks(8052));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.CustomerEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 10, 46, 21, 534, DateTimeKind.Local).AddTicks(7364));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.HourlyRateEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 10, 46, 21, 534, DateTimeKind.Local).AddTicks(9325));
                    ...
                    b.HasKey("Id", "ProjectId", "ContractorId");
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ProjectEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 10, 46, 21, 534, DateTimeKind.Local).AddTicks(7643));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.TimeSheetEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 6, 10, 46, 21, 534, DateTimeKind.Local).AddTicks(7832));
