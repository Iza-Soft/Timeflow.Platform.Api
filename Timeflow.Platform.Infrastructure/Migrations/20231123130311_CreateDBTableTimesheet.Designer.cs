...
namespace Timeflow.Platform.Infrastructure.Migrations
{
    ...
    [Migration("20231123130311_CreateDBTableTimesheet")]
    partial class CreateDBTableTimesheet
    {
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ProjectEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 23, 15, 3, 11, 203, DateTimeKind.Local).AddTicks(8074));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ServiceTypeEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 23, 15, 3, 11, 203, DateTimeKind.Local).AddTicks(9670));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.TaskEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 23, 15, 3, 11, 203, DateTimeKind.Local).AddTicks(8461));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.TimeSheetEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 23, 15, 3, 11, 203, DateTimeKind.Local).AddTicks(9947));
