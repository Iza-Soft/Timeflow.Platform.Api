...
namespace Timeflow.Platform.Infrastructure.Migrations
{
    ...
    [Migration("20231129142008_RemoveRelationTasksToServiceTypes")]
    partial class RemoveRelationTasksToServiceTypes
    {
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ProjectEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 29, 16, 20, 8, 120, DateTimeKind.Local).AddTicks(2952));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.TaskEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 16, 20, 8, 120, DateTimeKind.Local).AddTicks(3540));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.TimeSheetEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 29, 16, 20, 8, 120, DateTimeKind.Local).AddTicks(5426));
