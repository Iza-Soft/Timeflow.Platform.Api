...
namespace Timeflow.Platform.Infrastructure.Migrations
{
    ...
    [Migration("20231007185312_CreateCustomerTable")]
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ContractorEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 7, 21, 53, 12, 60, DateTimeKind.Local).AddTicks(9937));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.CustomerEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 21, 53, 12, 61, DateTimeKind.Local).AddTicks(3500));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.ProjectEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 21, 53, 12, 61, DateTimeKind.Local).AddTicks(3261));
            ...
            modelBuilder.Entity("Timeflow.Platform.Infrastructure.Entities.TimesheetEntity", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 7, 21, 53, 12, 61, DateTimeKind.Local).AddTicks(2367));
